...
export function Footer() {
  ...
  const handleSubscribeClick = () => {
    if (!email) {
      ...
      alert(
        "Cảm ơn bạn đã đăng ký, Chúng tôi sẽ sớm gửi thông tin cho bạn khi có cập nhật sớm nhất"
      );
    }
  };
            ...
            <div className="col-span-3" style={{ gap: 60 }}>
              <div>
                ...
                <div style={{ marginBottom: "25px", color: "#00ADEE" }}>
                  <p>
                    Đừng bỏ lỡ việc đăng ký các nguồn cấp dữ liệu mới của chúng
                    tôi, vui lòng điền vào hình thức dưới đây.
                  </p>
                </div>
                <div>
                  <form action="#">
