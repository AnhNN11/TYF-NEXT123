...
function Navbar() {
  return (
    <nav>
      <div className="container flex  sm:flex-row sm:justify-between sm:items-center flex-wrap gap-4 py-8">
        <Logo />
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="grid gap-3 p-4 mt-3 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                    ...
                    <NavigationMenuLink asChild>
                      ...
                      >
                        ...
                        <p className="text-sm leading-tight text-muted-foreground">
                          Công ty chuyên cung cấp dịch vụ trông trẻ và phát
                  ...
                  <ListItem href="/rentals" title="Hỗ Trợ">
                    Hỗ trợ khách hàng
                  </ListItem>
                </ul>
              </NavigationMenuContent>
            ...
            <NavigationMenuItem>
              <Link href="/thinking" legacyBehavior passHref>
                <NavigationMenuLink className={navigationMenuTriggerStyle()}>
                  Chia sẻ
                </NavigationMenuLink>
              </Link>
